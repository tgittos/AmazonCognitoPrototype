    ...
    public class JwtBearerHandler : AuthenticationHandler<JwtBearerOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            try
            {
                ...
                // Use the resolver to reconfigure the JwtBearerOptions if it's present
                if (Options.AudienceAuthorityResolver != null)
                {
                    Options.AudienceAuthorityResolver.Resolve(organizationId, Options);
                }
