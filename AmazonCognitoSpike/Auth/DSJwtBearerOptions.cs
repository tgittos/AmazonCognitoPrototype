...
namespace AmazonCognitoSpike.Auth
{
    ...
    public class JwtBearerOptions : AuthenticationSchemeOptions
    {
        ...
        /// <summary>
        /// Gets or sets the resolver to dynamically determin the audience/authority for a received OpenIdConnect token
        /// </summary>
        /// <value>The audience authority resolver.</value>
        public IAudienceAuthorityResolver AudienceAuthorityResolver { get; set; }
